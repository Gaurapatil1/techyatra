  ...
  <div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {languages.map((language) => (
        <Card
          key={language.id}
          className={`cursor-pointer transition-all duration-500 hover:shadow-2xl hover:scale-[1.02] bg-gradient-to-br from-white to-gray-50/50 backdrop-blur-sm border-0 shadow-lg ${expandedLanguage === language.id ? 'ring-2 ring-pink-400 shadow-2xl scale-[1.02]' : ''
            }`}
